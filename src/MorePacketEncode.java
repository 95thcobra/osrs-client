...
public class MorePacketEncode {
							...
							if (opcode >= 1100 && opcode < 1200 || opcode >= 2100 && opcode < 2200) {
								...
								if (opcode < 1600) {
									...
									if (opcode < 3700) {
										...
										if (opcode == 3619) { // Join clanchat enter name
											--var7;
											var52 = Class1.stringstack[var7];
											if (!var52.equals("")) {
												GameClient.secureBuffer.writeOpcode(13);
												System.out.println("CLANCHAT: " + Class56.calcStringBytes(var52));
												GameClient.secureBuffer.writeByte(Class56.calcStringBytes(var52));
												GameClient.secureBuffer.writeStr(var52);
												System.out.println("CLANCHAT2: " + var52);
											}
											continue;
										}
										...
										if (opcode < 4000) {
											...
											if (opcode < 4200) {
												...
												if (opcode == 5003) {
													...
													var16 = Class1.intstack[istackptr];
													var46 = Class1.intstack[istackptr + 1];
													CacheableEntry_Sub23_Sub12 var86 = NpcFlags.method129(var16, var46, -2031825513);
													if (var86 != null) {
	...
	MorePacketEncode() throws Throwable {
		throw new Error();
	}
